...
// 为整个应用程序加载 QSS
void UiUtil::loadQss() {
    QStringList qssFileNames = QStringList() << "PCD_4.0-resources/style/style.css"
                                             << "PCD_4.0-resources/style/SlotHome.css"
                                             << "PCD_4.0-resources/style/SlotParams.css"
                                             << "PCD_4.0-resources/style/SlotWarning.css"
                                             << "PCD_4.0-resources/style/SlotHistory.css";
    QString qss;
